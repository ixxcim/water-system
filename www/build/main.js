...
var MenuPage = /** @class */ (function () {
    function MenuPage(navCtrl, navParams, storage, loadingCtrl) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_auth_provider_authentication__ = __webpack_require__(289);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var HomePage = /** @class */ (function () {
    function HomePage(navCtrl, loadingCtrl, alertCtrl, storage, auth) {
        this.navCtrl = navCtrl;
        this.loadingCtrl = loadingCtrl;
        this.alertCtrl = alertCtrl;
        this.storage = storage;
    ...
    HomePage.prototype.loginUser = function () {
        ...
        if (userData.userid && userData.password) {
            this.auth.postData(userData).subscribe(function (res) {
                var userInfos = {
...
var AuthenticationProvider = /** @class */ (function () {
    ...
    AuthenticationProvider.prototype.postData = function (credentials) {
        var url = "http://" +
            this.localAddress +
